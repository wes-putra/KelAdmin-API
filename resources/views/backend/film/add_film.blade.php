					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="{{route('film.store')}}">
                                        @csrf
										<div class="control-group">
											<label class="control-label" for="basicinput">Judul</label>
											<div class="controls">
												<input type="text" id="basicinput" name="judul" placeholder="" class="span8">
											</div>
                                        </div>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
                                                <input type="text" id="basicinput" name="tahun" class="span8" aria-invalid="false">
											</div>
										</div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="basicinput" name="sutradara" class="span8">
                                            </div>
                                        </div>
