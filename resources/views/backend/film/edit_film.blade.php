					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="{{route('film.update', $editData->id)}}">
                                        @csrf
                                        <div class="control-group">
											<label class="control-label" for="basicinput">Judul</label>
											<div class="controls">
												<input type="text" id="basicinput" value="{{$editData->judul}}" name="judul" placeholder="" class="span8" disabled="">
											</div>
										</div>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="{{$editData->tahun}}" name="tahun" class="span8">
											</div>
                                        </div>

                                        <div class="control-group">
											<label class="control-label" for="basicinput">Sutradara</label>
											<div class="controls">
												<input type="text" id="basicinput" value="{{$editData->sutradara}}" name="sutradara" class="span8">
											</div>
                                        </div>
