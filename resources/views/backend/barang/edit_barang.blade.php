					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="{{route('barang.update', $editData->id)}}">
                                        @csrf
                                        <div class="control-group">
											<label class="control-label" for="basicinput">Nama</label>
											<div class="controls">
												<input type="text" id="basicinput" value="{{$editData->nama}}" name="nama" placeholder="" class="span8" disabled="">
											</div>
										</div>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="{{$editData->jumlah}}" name="jumlah" class="span8">
											</div>
                                        </div>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" value="{{$editData->harga}}" name="harga" class="span8">
											</div>
                                        </div>
